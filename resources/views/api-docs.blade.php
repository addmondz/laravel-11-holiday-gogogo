...
<body class="bg-gray-50 min-h-screen">
                    ...
                    <div class="space-y-8">
                        <div>
                            ...
                            <div class="endpoint-card">
                                ...
                                <div class="endpoint-body">
                                    <div class="code-block">
                                        <pre><code class="language-bash">curl -X POST {{ $baseUrl }}/{{ $botPrefix }}/fetch-room-types \
  ...
  -d '{"package_name": "Langkawi Island Resort"}'</code></pre>
                            ...
                            <div class="endpoint-card">
                                ...
                                <div class="endpoint-body">
                                    <div class="code-block">
                                        <pre><code class="language-bash">curl -X POST {{ $baseUrl }}/{{ $botPrefix }}/fetch-quotation \
  -H "Content-Type: application/json" \
  -d '{
    "package_name": "Langkawi Island Resort",
    "travel_date": "2024-01-15",
        ...
        "infants": 0
                        ...
                        <div>
                            ...
                            <div class="endpoint-card">
                                ...
                                <div class="endpoint-body">
                                    <div class="code-block">
                                        <pre><code class="language-javascript">const response = await fetch('{{ $baseUrl }}/{{ $botPrefix }}/fetch-room-types', {
  method: 'POST',
  headers: {
...
console.log(data);</code></pre>
                            ...
                            <div class="endpoint-card">
                                ...
                                <div class="endpoint-body">
                                    <div class="code-block">
                                        <pre><code class="language-javascript">const response = await fetch('{{ $baseUrl }}/{{ $botPrefix }}/fetch-quotation', {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json',
  },
