...
<template>
    ...
    <div class="flex min-h-screen flex-col items-center bg-indigo-500/5 pt-6 sm:justify-center sm:pt-0 dark:bg-gray-900 justify-center">
        <div>
            <Link href="/">
                <ApplicationLogo class="h-20 w-20 fill-current text-gray-500" style="max-width: 300px;" />
            </Link>
        </div>
